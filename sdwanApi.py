...
#Login API Credentials and resources
...
print('{0:20s}{1:1}{2:12s}{3:1}{4:36s}{5:1}{6:16s}{7:1}{8:7s}'
        .format("Host-Name", "|", "Device Model", "|", "Device ID","|", "System IP", "|", "Site ID"))
print('-'*105)

for ITEM in DEVICE_ITEMS:
    print ('{0:20s}{1:1}{2:12s}{3:1}{4:36s}{5:1}{6:16s}{7:1}{8:7s}'
    .format(ITEM['host-name'], "|", ITEM['device-model'], "|", ITEM['uuid'], "|", ITEM['system-ip'], "|", ITEM['site-id']))
...
print('{0:20s}{1:1}{2:12s}{3:1}{4:36s}{5:1}{6:16s}{7:1}{8:7s}'
.format("Template Name", "|", "Device Model", "|" , "Template ID" , "|", "Attached devices", "|", "Template Version" ))
...
for ITEM in TEMPLATE_ITEMS:
    ...
    .format(ITEM['templateName'], "|", ITEM['deviceType'], "|", ITEM['templateId'], "|", ITEM['devicesAttached'], "|", ITEM['templateAttached']))
